...
public class SeqScan implements OpIterator {
    ...
    public TupleDesc getTupleDesc() {
        ...
        Type[] typeAr = new Type[oldTD.numFields()];
        String[] fieldAr = new String[oldTD.numFields()];
        for(int i = 0; i < oldTD.numFields(); i++){
            typeAr[i] = oldTD.getFieldType(i);
            fieldAr[i] = prefix + "." + oldTD.getFieldName(i);
        }
